...
{
    public class LotanShaviSkipList_v2<T> : IConcurrentPriorityQueue<T>
    {
        /// <summary>
        /// works, but is slow
        /// </summary>
        ...
        public LotanShaviSkipList_v2() : this(32) { }

        public LotanShaviSkipList_v2(int max)
        {
        ...
        public T DeleteMax()
        {
           ...
           // start = DateTime.Now.Ticks / TimeSpan.TicksPerMillisecond;
            ...
            //Interlocked.Add(ref timeToSearch, stop);
