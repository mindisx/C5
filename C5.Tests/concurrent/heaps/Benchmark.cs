...
//            ConcurrentChromaticTreeMap<String> String> standardDictionary;
//            ConcurrentChromaticTreeMap<String> String> customDictionary;
...
//            {
//                var element = threadQueue.Dequeue().Value.ToString();
//                standardList.Add(element);
//                customList.Add(element);
//            }

//            customDictionary = new ConcurrentChromaticTreeMap<String> String > (6, StringComparer.Ordinal);
//            timer.Reset();
//            timer.Start();
//            foreach (String element in customList)
//            {
//                customDictionary.Add(element, element);
//            }
//            timer.Stop();
...
//            foreach (String element in customList)
//            {
//                customDictionary.Get(element);
//            }
//            timer.Stop();
//            Console.WriteLine("Custom time Get:   " + timer.ElapsedTicks);

//            standardDictionary = new ConcurrentChromaticTreeMap<String> String > (6);

//            timer.Reset();
//            timer.Start();
//            foreach (String element in standardList)
//            {
//                standardDictionary.Add(element, element);
//            }
//            timer.Stop();
...
//            foreach (String element in standardList)
//            {
//                standardDictionary.Get(element);
//            }
//            timer.Stop();
...
//                while ((SecondsPerTestTimer.ElapsedMilliseconds / 1000.0) lower((config.SecondsPerTest * 1.0) / config.Threads[config.Threads.Length - 1]) || runs lower or equal((config.WarmupRuns) + config.Threads[0])) {
//                    */

//// Create the correct dictionary for this run
//dictionary = (IBenchmarkable<Integer, Integer>)Activator.CreateInstance(type);
...
//                        Queue<Integer> threadQueue = generateRandomQueue(steadyStateSize, config.StartRangeRandom, config.EndRangeRandom);
//                        while (threadQueue.Count > 0)
//                        {
//                            Integer element = threadQueue.Dequeue();
...
//                        Queue<Integer> threadQueue = generateRandomQueue(config.CurrentNumberOfElements, start, end);
...
//        static Queue<Integer> generateRandomQueue(int size, int RandomStartRange, int RandomEndRange)
//        {
...
//                queueToReturn.Enqueue(new Integer(randomInt));
//            }
...
//            Queue<Integer> threadQueue = (Queue<Integer>)state;
...
//                {
//                    dictionary.Add(element, System.Threading.Thread.CurrentThread.ManagedThreadId.ToString());
//                    dictionary.Add(element, element);
//                }
